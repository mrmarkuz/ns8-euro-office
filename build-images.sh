...
# --label="org.nethserver.images=docker.io/mariadb:10.11.5 docker.io/roundcube/roundcubemail:1.6.16-apache"
...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=ghcr.io/euro-office/documentserver:v9.3.2" \
    "${container}"
# Commit the image
